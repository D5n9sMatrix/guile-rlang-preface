...
Many users will come to R mainly for its graphical facilities. See [Graphical procedures](https://cloud.r-project.org/doc/manuals/r-release/R-intro.html#Graphics), which can be read at almost any time and need not wait until all the preceding sections have been digested.
